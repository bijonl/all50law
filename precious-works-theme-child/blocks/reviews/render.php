...
$has_content = !empty($reviews) || $has_button_area || $has_title_area;
...
<section <?php echo pw_block_section_classes($block); ?>>
    ...
    <?php } elseif ($review_format === 'slider') { ?>

        <?php include locate_template('blocks/reviews/partials/review-slider.php'); ?>
